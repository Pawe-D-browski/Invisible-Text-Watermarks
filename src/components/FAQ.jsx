import { Container, Stack, Heading, Text, Accordion } from "@chakra-ui/react";

const faqItems = [
  {
    title: "What are Invisible Text Watermarks?",
    content:
      "Invisible Text Watermarks are a way to prove ownership of your digital articles, blog posts, e-books, and other texts if somebody copies them without your permission." +
  ...
  },
  {
    ...
    content:
      ...
      "\nThese characters are not visible when your text is displayed but can be detected through special analysis." +
  ...
  },
  {
    ...
    content:
      "To apply a watermark, simply go to the 'Apply Watermark' tab, paste your text, write your watermark message, and click the 'Apply' button.",
  },
  {
    title: "How do I decode an Invisible Watermark from text?",
    content:
      "To read a watermark, go to the 'Decode Watermark' tab, paste a text, and click the 'Decode' button." +
